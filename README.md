...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-lua/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-lua/actions/workflows/validate.yml)

Neovim tree-sitter queries for **lua**, part of the
...
- [ ] Changes are scoped to `lua` — do not include files for other languages
